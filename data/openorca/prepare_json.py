...
# 处理train
processed_train_ds = split_ds["train"].map(generate_and_tokenize_prompt, batched=False)

# 处理val
processed_val_ds = split_ds["test"].map(generate_and_tokenize_prompt, batched=False)
